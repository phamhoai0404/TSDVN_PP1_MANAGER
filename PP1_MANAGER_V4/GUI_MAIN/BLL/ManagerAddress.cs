...
namespace GUI_MAIN.BLL
{
    public class ManagerAddress
    {
        ...
        {
            //bool isExcel2003 = false;
            //try
            //{
            //    // Kiểm tra phiên bản Excel để xác định liệu có sử dụng định dạng .xls hay .xlsx
            //    isExcel2003 = wbTemp.FileFormat == MyExcel.XlFileFormat.xlExcel8;
            //}
            //catch (Exception)
            //{
            //    // Xử lý ngoại lệ nếu không thể xác định phiên bản Excel
            //    // Thực hiện các xử lý phù hợp tùy theo yêu cầu của bạn
            //}
            ...
            //    foreach (object sheetObj in wbTemp.Sheets)
            //    {
            //        if (sheetObj is MyExcel.Worksheet sheet && sheet.CodeName == tempSheet)
            //        {
            //            return true;
            //        }
            //    }
